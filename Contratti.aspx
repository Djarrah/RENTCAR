<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Contratti.aspx.cs" Inherits="Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnInserisci').click(function () {
                var url = '/forms/inserisci/insContratti.aspx';
            ...
            $('#btnModifica').click(function () {
                var url = '/forms/modifica/modContratti.aspx';
                var dialog = $('<iframe src="' + url + '" frameborder="0"></iframe>').appendTo('body');
            ...
            $('#btnElimina').click(function () {
                var url = '/forms/elimina/eliContratti.aspx';
                var dialog = $('<iframe src="' + url + '" frameborder="0"></iframe>').appendTo('body');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    ...
    <div class="bg-primary py-4">
        <div class="container">
            <asp:GridView ID="griglia" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="griglia_SelectedIndexChanged" CssClass="table table-striped table-borderless bg-white" DataKeyNames="codiceContratto">
                <Columns>
                    <asp:BoundField DataField="codiceContratto" HeaderText="ID" Visible="False" />
                    ...
                    <asp:BoundField DataField="prezzo" HeaderText="Prezzo Mensile" />
                    <asp:BoundField DataField="dataInizioContratto" HeaderText="Inizio Contratto" />
                    <asp:BoundField DataField="dataTermineContratto" HeaderText="Termine Contratto" />
                    <asp:BoundField DataField="totContratto" HeaderText="Totale Contratto" />
                    <asp:BoundField DataField="totFatturato" HeaderText="Totale Fatturato" />
