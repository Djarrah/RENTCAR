<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insAuto.aspx.cs" Inherits="inserimento" %>
    ...
    <form id="form1" runat="server">
        <div class="bg-dark container-fluid py-3">
            <table>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txtData" runat="server" CssClass="form-control border-light" ToolTip="Data Acquisto" TextMode="Date"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
